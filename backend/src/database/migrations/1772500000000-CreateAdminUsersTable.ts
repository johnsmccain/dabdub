...
export class CreateAdminUsersTable1772500000000 implements MigrationInterface {
  name = 'CreateAdminUsersTable1772500000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "admin_users" (
        ...
        "revokedPermissions" jsonb NOT NULL DEFAULT '[]',
        "avatarUrl" varchar,
        "phoneNumber" varchar,
    ...
    await queryRunner.query(`CREATE INDEX "IDX_admin_users_status" ON "admin_users" ("status")`);
    await queryRunner.query(`CREATE INDEX "IDX_admin_users_deletedAt" ON "admin_users" ("deletedAt")`);
  }
